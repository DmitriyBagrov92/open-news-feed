...
function withHardTimeout(fn) {
  ...
  const timeout = new Promise((_, reject) =>
    setTimeout(() => reject(new Error(`timed out after ${HARD_TIMEOUT_MS}ms`)), HARD_TIMEOUT_MS + 500)
  );
...
export function query({ category, q, sources: include, exclude, page, pageSize, lang, since } = {}) {
